...
import {
  IEducationAdd,
  IExperienceAdd,
  ILanquageKnownResponse,
  IStaffAutocompleteRequest,
  IStaffDetailsUpdate,
  IStaffEducationResponse,
  IStaffExperienceResponse,
  IStaffLanguageResponse,
  IStaffRequest,
...
export class ViewStaffComponent implements OnInit {
  ...
  public profileguid: IProfileRequest = {
    guid: 0,
  };
  public recordinfo: TableRecordInfo = new TableRecordInfo();
  // #region All Table List
  LanguageknownList: ILanquageKnownResponse[] = [];
  ILanquageKnownList: IStaffLanguageResponse[] = [];
  EducationDetailList: IStaffEducationResponse[] = [];
  ExperienceDetailList: IStaffExperienceResponse[] = [];
  ...
  public StaffID: StaffDetailsPKRequest = {
    sysId: 0,
  };
  public LanguageknowRequest: IStaffLanguageResponse = {
    sysId: 0,
    languageKnow: '',
    readLanguage: 'No',
    writeLanguage: 'No',
  ...
  public EducationDetailRequest: IEducationAdd = {
    degreeType: '',
    degree: '',
    yearOfPassing: '',
    universityName: '',
  ...
  public ExperienceDetailRequest: IExperienceAdd = {
    InstituionName: '',
    position: '',
    fromDate: '',
    toDate: '',
  ...
  public request: IStaffDetailsUpdate = {
    sysid: 0,
    title: '',
    name: '',
    initial: '',
  ...
  navigateToStaffList(): void {
    this.router.navigate(['CMS/ViewStaffList']);
  }
  ...
  AddLanguage(): void {
    ...
    const { readLanguage, writeLanguage, speakLanguage, languageKnow } = this.LanguageknowRequest;
    ...
    const existingIndex = this.LanguageknownList.findIndex(
      (item) => item.Language.toLowerCase() === languageKnow.toLowerCase(),
    );
    ...
    this.staffService.AddStaffLanguageDetails(this.LanguageknowRequest).subscribe({
      next: () => {
        this.LanguageknowRequest.languageKnow = '';
  ...
  onStaffEducationEditClick(value: any): void {
    ...
    this.EducationDetailRequest.instituionName = selectedRecord?.institutionName ?? '';
  ...
  onEditExperienceClick(recordId: any): void {
    ...
    if (selectedRecord) {
      this.ExperienceDetailRequest = {
        InstituionName: selectedRecord.institutionName || '',
        position: selectedRecord.position || '',
        fromDate: selectedRecord.fromDate ? new Date(selectedRecord.fromDate).toISOString() : '',
        toDate: selectedRecord.toDate ? new Date(selectedRecord.toDate).toISOString() : '',
        yearsOfExperience: selectedRecord.yearsOfExperience?.toString() || '',
        salary: selectedRecord.salary?.toString() || '',
        sysId: recordId,
      };
    }
